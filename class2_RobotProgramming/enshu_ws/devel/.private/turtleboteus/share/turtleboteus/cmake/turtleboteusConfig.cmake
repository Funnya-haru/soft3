...
if("TRUE" STREQUAL "TRUE")
  set(turtleboteus_SOURCE_PREFIX /home/mech-user/Desktop/soft3/class2_RobotProgramming/enshu_ws/src/robot-programming/turtleboteus)
  set(turtleboteus_DEVEL_PREFIX /home/mech-user/Desktop/soft3/class2_RobotProgramming/enshu_ws/devel/.private/turtleboteus)
  ...
  set(turtleboteus_INSTALL_PREFIX /home/mech-user/Desktop/soft3/class2_RobotProgramming/enshu_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'turtleboteus' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'turtleboteus' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mech-user/Desktop/soft3/class2_RobotProgramming/enshu_ws/src/robot-programming/turtleboteus/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT turtleboteus_NUM_DUMMY_TARGETS)
      set(turtleboteus_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::turtleboteus::wrapped-linker-option${turtleboteus_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR turtleboteus_NUM_DUMMY_TARGETS "${turtleboteus_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::turtleboteus::wrapped-linker-option${turtleboteus_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND turtleboteus_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mech-user/Desktop/soft3/class2_RobotProgramming/enshu_ws/devel/.private/turtleboteus/lib;/home/mech-user/Desktop/soft3/class2_RobotProgramming/enshu_ws/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${turtleboteus_dep}_FOUND)
      find_package(${turtleboteus_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${turtleboteus_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
